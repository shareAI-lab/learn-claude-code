...
> **当前状态**：M2 完成 —— 103 个测试通过。支持 Agent Loop、6 个内置工具、TodoWrite / 持久化 Tasks / Subagent / Skills / 记忆 / 上下文压缩 / 分角色模型 / Session 持久化 / 后台任务 / MCP stdio。
...
- **M3** ⏳ 多 Agent 协作 / Worktree 隔离 / MCP sse+http / 发布 PyPI
