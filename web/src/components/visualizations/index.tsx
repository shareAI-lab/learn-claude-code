...
> = {
  ...
  s05: lazy(() => import("./s05-todo-write")),
  ...
  s12: lazy(() => import("./s12-task-system")),
  s13: lazy(() => import("./s13-background-tasks")),
  s14: lazy(() => import("./s14-cron-scheduler")),
  s15: lazy(() => import("./s15-agent-teams")),
  s16: lazy(() => import("./s16-team-protocols")),
  s17: lazy(() => import("./s17-autonomous-agents")),
  s18: lazy(() => import("./s18-worktree-task-isolation")),
