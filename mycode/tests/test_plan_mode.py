...
from mycode.agent.dispatcher import ToolCall, dispatch
from mycode.config import load_config
from mycode.tools.ask_user import register_ask_user
from mycode.tools.builtin import register_builtins, reset_session_state
from mycode.tools.plan_mode import (
    PlanModeState,
...
def test_exit_non_interactive_returns_error():
    from mycode.tools.ask_user import InteractiveUnavailable, non_interactive_ask
