...
def set_run_font(run, font_name='宋体', size=10.5, bold=False):
...
def add_para(doc, text, align='left', bold=False, size=10.5, first_line_indent=0):
    p = doc.add_paragraph()
    run = p.add_run(text)
...
hr = hp.add_run("XX科技股份有限公司 · 2024年第一季度财务分析报告")
...
add_para(doc, "", size=12)
add_para(doc, "XX科技股份有限公司", align='center', bold=False, size=16)
...
p_audit = add_para(doc, "审计状态：待审计", align='center', size=12)
p_audit.runs[0].font.color.rgb = RGBColor(192, 0, 0)

doc.add_page_break()

# 目录
add_heading_custom(doc, "目录", level=1)
add_para(doc, "一、财务摘要.....................................................................1")
add_para(doc, "二、收入分析.....................................................................2")
add_para(doc, "    2.1 按产品线.................................................................2")
add_para(doc, "    2.2 按区域...................................................................2")
add_para(doc, "三、成本结构.....................................................................3")
add_para(doc, "四、利润分析.....................................................................4")
add_para(doc, "五、现金流概况.................................................................5")
add_para(doc, "六、风险提示与建议.............................................................6")
doc.add_page_break()
