...
この図の中で一番重要なのは「次の turn」へ戻るループ構造そのものではありません。

最も重要なのは次の 1 文です。

**tool の結果は messages へ write-back され、次の turn の推論入力になる**

ここが欠けると、model は現実の観察を踏まえた上で次の一手を考えられません。
