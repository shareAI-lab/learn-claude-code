...
def read_file(path: str, limit: int | None = None) -> str:
    ...
    track_recent_file(ACTIVE_STATE, path)
...
def compact(focus: str = "") -> str:
    ...
    ACTIVE_STATE.compact_requested = True
    ACTIVE_STATE.compact_focus = focus or None
...
def build_agent(state: CompactState = COMPACT_STATE):
    global ACTIVE_STATE
    ACTIVE_STATE = state
